import * as translations from './translation.js';
/* ===================================
    About
====================================== */
...
window.onSelectLang = function onSelectLang(from) {
    if (from === 'mobile') {
        setLanguage(document.getElementById("language-select-mobile").value);
        localStorage.setItem("lang", document.getElementById("language-select-mobile").value);
    } else {
    ...
    // document.body.style.textAlign = language === 'en' ? 'left' : 'right'
        ...
        const setLanguage = (language) => {
            ...
            elements.forEach((element) => {
                ...
                element.localName === 'input' ? element.placeholder = translations.default[language][translationKey] : element.textContent = translations.default[language][translationKey];
            });
